...
if ( ! class_exists( 'TwitterWP' ) ) :
	...
	class TwitterWP {
		...
		public function get_user( $user = '' ) {
			...
			if ( ! self::$user ) {
				return new WP_Error( 'twitterwp_error', __( 'ERROR: You need to provide a user.', 'ws-theme-addons' ) );
			}
		...
		public function api_bearer_token() {
			...
			if ( ! isset( $body->access_token ) ) {
				return new WP_Error( 'twitterwp_error', __( 'ERROR: Could not retrieve bearer token.', 'ws-theme-addons' ) );
			}
		...
		public static function app_setup_error( $app = array(), $return = false ) {
			...
			return new WP_Error( 'twitterwp_error', __( 'ERROR: Missing Twitter App credentials.', 'ws-theme-addons' ) );
		}
