...
if ( ! class_exists( 'ReduxFramework_switch' ) ) {
    class ReduxFramework_switch {
        ...
        function render() {
            ...
            //Label ON
            $this->field['on'] = isset( $this->field['on'] ) ? $this->field['on'] : __( 'On', 'redux-framework', 'ws-theme-addons' );

            //Label OFF
            $this->field['off'] = isset( $this->field['off'] ) ? $this->field['off'] : __( 'Off', 'redux-framework', 'ws-theme-addons' );
